...
namespace CN.Jpush.Android.Service {
	...
	public partial class AlarmReceiver : global::Android.Content.BroadcastReceiver, global::Java.Lang.IRunnable {

		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("cn/jpush/android/service/AlarmReceiver", typeof (AlarmReceiver));
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='cn.jpush.android.service']/class[@name='AlarmReceiver']/method[@name='run' and count(parameter)=0]"
